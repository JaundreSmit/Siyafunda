<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmEducator.aspx.cs" Inherits="SiyafundaApplication.frmEducator" %>
...
<body>
    <form id="form1" runat="server">
        <table style="width:100%;">
            ...
            <tr>
                <td class="auto-style10">&nbsp;<asp:RadioButtonList ID="rblStudentFilter" runat="server" AutoPostBack="True" OnSelectedIndexChanged="rblStudentFilter_SelectedIndexChanged">
                    </asp:RadioButtonList>
                </td>
                <td class="auto-style12">Search: <asp:TextBox ID="txtSearchStudents" runat="server" AutoPostBack="True" OnTextChanged="txtSearchStudents_TextChanged"></asp:TextBox>
    ...
    <td class="auto-style9">
        <asp:Button ID="btnRemoveStudent" runat="server" OnClick="btnRemoveStudent_Click" Text="Remove Student" />
                &nbsp;<asp:Button ID="btnAssignStudent" runat="server" OnClick="btnRemoveStudent_Click" Text="Add Student" />
                </td>
