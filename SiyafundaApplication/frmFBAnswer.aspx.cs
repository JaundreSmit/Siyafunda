...
{
    public partial class frmFBAnswer : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                // Load the current fill-in-the-blank question
        ...
        private void LoadQuestion(int questionId)
        {
            ...
            {
                con.Open();
                string query = "SELECT question_text FROM FBQuestions WHERE question_id = @QuestionId";
        ...
        private void RedirectToNextQuestion()
        {
            ...
            if (currentQuestionIndex < questions.Count)
            {
                ...
                // Redirect based on question type to specific forms
