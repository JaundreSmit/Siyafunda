...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td class="auto-style8">
                <asp:DropDownList ID="ddlAddEducator" runat="server"></asp:DropDownList>
            </td>
        </tr>
        <tr>
    ...
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td class="auto-style8">
                <asp:DropDownList ID="ddlEditModSelect" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlEditModSelect_SelectedIndexChanged"></asp:DropDownList>
            </td>
        </tr>
        <tr>
            <td class="auto-style2">Title:</td>
        ...
        <tr>
            <td class="auto-style2">Educator:</td>
            <td class="auto-style8">
                <asp:DropDownList ID="ddlEditEducator" runat="server"></asp:DropDownList>
            </td>
        </tr>
        <tr>
            <td class="auto-style2">
