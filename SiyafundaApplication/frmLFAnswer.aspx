<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmLFAnswer.aspx.cs" Inherits="SiyafundaApplication.frmLFAnswer" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:TextBox ID="txtAnswer" runat="server" TextMode="MultiLine" Rows="6" Width="400px"></asp:TextBox>
